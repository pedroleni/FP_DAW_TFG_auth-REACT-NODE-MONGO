...
export const autologinUser = async (formData) => {
  return APIuser()
    .post("/users/login/autologin", formData)
    .then((res) => res)
    .catch((error) => error);
};
...
export const forgotPasswordUser = async (formData) => {
  return APIuser()
    .patch("/users/forgotpassword", formData)
    .then((res) => res)
    .catch((error) => error);
};
...
export const updateUser = async (formData) => {
  return APIuser()
    .patch("/users/update/update", formData, {
      headers: {
